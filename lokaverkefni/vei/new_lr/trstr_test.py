...
def noisy_gaussian_wave_function(x, k=10, sigma=0.3, A=1, alpha=0.01):
...
if __name__ == "__main__":
    ...
    eigen = eigen[::-1]
    trainer = Trist_train(x_vals,psi_vals,model,eigen,opt=1,epochs=5000,decay=False)
